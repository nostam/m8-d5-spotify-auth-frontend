    ...
    return (
      <>
        ...
        {this.state.loading ? (
          ...
          <div
            className="album row bootstrapOverwrite"
            style={{
                  ...
                  <div className="last-line mt-2 mb-2">
                    ...
                    <h6>
                      <a className="group-name">
                        <Link
                          to={`/artistPage/${this.state.album.artist.name}`}
                        >
                    ...
                    <p className="album-length">
                      {this.state.album.release_date.slice(0, 4)} •
                      {this.state.album.tracks.data.length} songs,
                      {this.toMinutes(this.state.album.duration)}{" "}
                    </p>
                  </div>
                </div>
              </Col>
